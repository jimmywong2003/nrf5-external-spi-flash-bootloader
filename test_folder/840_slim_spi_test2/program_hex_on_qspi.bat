...
objcopy -v -I binary -O ihex --change-addresses 0x12010000 ble_app_test2_pca10056_s140.dat init_pkt_2.hex 
objcopy -v -I binary -O ihex --change-addresses 0x12011000 ble_app_test2_pca10056_s140.bin   fw_bin_2.hex
...
nrfjprog -f nrf52 --qspicustominit --program init_pkt_2.hex 
nrfjprog -f nrf52 --qspicustominit --program fw_bin_2.hex
